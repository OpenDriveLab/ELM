...
@registry.register_model("blip2_vqa_t5_emdmulti")
class Blip2VQAT5EMDMULTI(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    def __init__(
        ...
        # del self.slot_attention
        # del self.extra_query_tokens
    ...
    def from_config(cls, cfg):
        ...
        # model.extra_query_tokens = torch.cat([model.query_tokens]*3, dim=1)
        # model.print_trainable_parameters()
        return model